...
Statements are usually generated on a schedule (e.g., semi-annually).

1.  Navigate to **Royalties > Generate Statements**.
2.  Select the **Period** (e.g., Jan 1 2025 – Jun 30 2025).
3.  Click **Generate**.
